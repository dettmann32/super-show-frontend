    ...
    <div class=" w-[100vw] m-auto  mb-5">
        ...
        <div class=" relative mt-5 m-auto">
            ...
            <input type="text" id="name-with-label" v-model="subject"
                class=" rounded-lg  mt-10 mb-5 m-auto flex-1 appearance-none border border-gray-600 w-[80%] py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                name="subject" placeholder="Assunto" />
        </div>


        <div class="text-gray-700 mt-10 w-[80%] ">
            <input v-model="message"
                class="flex-1 w-full h-[200px] m-auto px-4 py-2  text-gray-700 placeholder-gray-400 bg-white border border-gray-600 rounded-lg appearance-none focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
