<template>
    <div class="min-h-[50vh]">
        ...
        <h1 class="text-center">Rejeitados</h1>
...
async function fetchData() {
    try {
        const response = await axios.get('http://192.168.0.181:3333/adm/clientsReject', config)
