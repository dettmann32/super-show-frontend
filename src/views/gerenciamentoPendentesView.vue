                        ...
                        <div class=" flex items-center">
                            ...
                            <div class="hidden md:block">
                                <div class="flex items-baseline ml-10 space-x-4">
                                    <router-link
                                        class="text-white hover:text-gray-300  px-3 py-2 rounded-md text-md font-medium"
                                        to="/gerenciamento">
                                        Solicitados
                                    </router-link>
                                    <router-link
                                        class="text-white  hover:text-gray-300 dark:hover:text-white px-3 py-2 rounded-md text-md font-medium"
                                        to="/Rejeitados">
                                        Recusados
                                    </router-link>
                                    <router-link
                                        class="text-gray-300  hover:text-gray-300 dark:hover:text-white px-3 py-2 rounded-md text-md font-medium"
                                        to="/Pendentes">
                                        Pendentes
                                    </router-link>
